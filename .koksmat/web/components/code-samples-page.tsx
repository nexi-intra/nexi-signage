...
import { typeNames } from '@/app/signage/schemas/forms'
...
import { ApiClient } from '@/app/signage/api/entity/api-client'
import { ${typeName} } from '@/app/signage/api/entity/schemas'
