Import-Module -Name ".\PSWriteWord.psd1" #-Force 
...
Add-WordText -WordDocument $WordDocument -Text "Invoice Data with just 1 entry - with break page before table" -FontSize 48 -Alignment center -ShadingType Paragraph -ShadingColor Blue -Supress $true 
Add-WordParagraph -WordDocument $WordDocument -Supress $true 
